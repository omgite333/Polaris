...
/*
* Builds the the full path to a file by traversing up the parent chain 
* Input: A file ID(eg the ID of "button.tsx")
* Output: Array of ancestors from root to file : [{_id, name:"src"} ,{_id, name:"components"} ,{_id, name:"button.tsx"}]

* Used for: Breadcrumps navigation (src > components > button.tsx)
*/
...
export const createFile = mutation({
 ...
 // Check if the file with same name already exist in this parent folder
...
export const createFolder = mutation({
 ...
 // Check if the folder with same name already exist in this parent folder
  ...
  args: {
    ...
    handler: async (ctx,args) =>{
     ...
     //Recursively delete file/folder and all descendants
        ...
        // If its a folder , delete all the childerns first
         if(item.type === "folder") {
