    ...
    <div className="h-full bg-sidebar">
     <ScrollArea>
      <div 
       ...
       className="group/project cursor-pointer w-full text-left flex items-center gao-0.5 h-5.5 bg-accent font-bold"
      >
        <ChevronRightIcon 
          className={cn(
            "size-4 shrink-0 text-mute-foreground",
            isOpen && "rotate-90"
          )}
        />
